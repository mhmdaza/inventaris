        ...
        <div class="card shadow-sm border-bottom-info">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="tgl_brg_rusak">Tanggal</label>
                    <div class="col-md-4">
                        <input value="<?= set_value('tgl_brg_rusak', date('Y-m-d')); ?>" name="tgl_brg_rusak" id="tgl_brg_rusak" type="text" class="form-control date" placeholder="Tanggal Rusak...">

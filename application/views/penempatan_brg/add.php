                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('nama_penempatan'); ?>" name="nama_penempatan" id="nama_penempatan" type="text" class="form-control" placeholder="Nama Penempatan...">
                        </div>
